...
gulp.task("run-tests-chrome", function () {
  const browser = os.platform() === "linux" ? "google-chrome" : os.platform() === "darwin" ? "google chrome" : "chrome";
...
gulp.task("lint-src", function () {
  return gulp.src("src/**/*.js").pipe(eslint(".eslintrc.json")).pipe(eslint.format()).pipe(eslint.failAfterError());
});
